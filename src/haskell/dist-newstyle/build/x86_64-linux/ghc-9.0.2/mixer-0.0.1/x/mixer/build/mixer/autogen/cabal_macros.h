...
/* package mixer-0.0.1 */
#ifndef VERSION_mixer
#define VERSION_mixer "0.0.1"
#endif /* VERSION_mixer */
#ifndef MIN_VERSION_mixer
#define MIN_VERSION_mixer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 1)
#endif /* MIN_VERSION_mixer */
...
#define CURRENT_COMPONENT_ID "mixer-0.0.1-inplace-mixer"
